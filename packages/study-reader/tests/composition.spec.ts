...
describe('study-reader bundle patch', () => {
  it('inserts only the selection/memory and evidence seams', () => {
    ...
    expect(names.get('document-extraction')).toBe('@deepseek-ai/dsh-study-reader/extraction')
    expect(names.get('document-extraction-mineru')).toBe('@deepseek-ai/dsh-study-reader/mineru')
    expect(names.get('study-memory')).toBe('@deepseek-ai/dsh-study-reader/memory')
    expect(names.get('study-memory-durable')).toBe('@deepseek-ai/dsh-study-reader/memory-durable')
    expect(names.has('study-reader-state')).toBe(false)
    expect(names.has('study-reader-state-durable')).toBe(false)
    expect(names.get('study-agent')).toBe('@deepseek-ai/dsh-study-reader/agent')
    expect(names.get('study')).toBe('@deepseek-ai/dsh-study-reader/study')
    expect(names.get('ui-study')).toBe('@deepseek-ai/dsh-study-reader')
  })
...
describe('reading preset composition', () => {
  ...
  it('keeps native Skill loading and the six Reader Tool runtime', () => {
    ...
    expect(byId.get('tool-study')?.name).toBe('@deepseek-ai/dsh-study-reader/tools')
